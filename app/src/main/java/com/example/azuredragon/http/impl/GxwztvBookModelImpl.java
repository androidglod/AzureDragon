...
import com.example.azuredragon.http.api.IGxwztvApi;
...
import com.example.azuredragon.http.bean.WebChapterBean;
import com.example.azuredragon.http.impl.module.IGxwztvBookModel;
...
import com.example.azuredragon.widget.ErrorAnalyContentManager;
...
public class GxwztvBookModelImpl extends BaseModelImpl implements IGxwztvBookModel {
     ...
     */
    @Override
    public io.reactivex.Observable<LibraryBean> getLibraryData(final ACache aCache) {
