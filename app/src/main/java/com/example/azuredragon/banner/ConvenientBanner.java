package com.example.azuredragon.banner;
...
import com.example.azuredragon.banner.adapter.CBPageAdapter;
import com.example.azuredragon.banner.holder.CBLoopScaleHelper;
import com.example.azuredragon.banner.holder.CBViewHolderCreator;
import com.example.azuredragon.banner.listener.CBPageChangeListener;
import com.example.azuredragon.banner.listener.OnItemClickListener;
import com.example.azuredragon.banner.listener.OnPageChangeListener;
...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.commwidget_ConvenientBanner);
        canLoop = a.getBoolean(R.styleable.commwidget_ConvenientBanner_commwidget_canLoop, true);
        autoTurningTime = a.getInteger(R.styleable.commwidget_ConvenientBanner_commwidget_autoTurningTime, -1);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.commwidget_cbloop_viewpager, this, true);
